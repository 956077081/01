...
function updateSubMenuByZhuyuanIDforYishi()
{
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/Yizhuguanli/showChangqi/zhuyuan_id/"+current_zhixing_id+"/yiyuan_id/"+current_bingli_yiyuan_id;
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/ZhuyuanYishi/Patient/showPatientZhuyuanDetailUrl/zhuyuan_id/"+current_zhixing_id+"/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		
		
		var type=encodeURI("住院病案首页");
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/printBingli/zhuyuan_id/"+current_zhixing_id+"/bingli_type/"+type+"/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		...
		$.getJSON("http://"+server_url+"/web_emr/Home/BingliEditor/getBingliTree", {zhuyuan_id:current_zhixing_id,yiyuan_id:current_bingli_yiyuan_id}, function(data){
			...
			for(var bingli_count=0;bingli_count<data.length;bingli_count++)
			{
				...
				temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/printBingli/zhuyuan_id/"+current_zhixing_id+"/bingli_type/"+data[bingli_count].bingli_type+"/yiyuan_id/"+current_bingli_yiyuan_id;
				temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
				continue_number_linchuang++;
			}
		});
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][1] = "ruyuan_jilu";
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showBingli/zhuyuan_id/"+current_zhixing_id+"/bingli_type/入院记录/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showBingli/zhuyuan_id/"+current_zhixing_id+"/bingli_type/病程记录/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang ++;
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			...
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showBingli/zhuyuan_id/"+current_zhixing_id+"/bingli_type/出院记录/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		*/
...
function updateSubMenuByMubanIDforYishi()
{
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			temp_sub_menu_linchuang[continue_number_linchuang][0] = "بالنىتسىغا ئېلىنىش خاتىرىسى(入院记录)";
			temp_sub_menu_linchuang[continue_number_linchuang][1] = "ruyuan_jilu";
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showMubanBingli/muban_id/"+current_muban_id+"/muban_bingli_type/入院记录/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			temp_sub_menu_linchuang[continue_number_linchuang][0] = "كېسەللىك جەريانى خاتىرىسى(病程记录)";
			temp_sub_menu_linchuang[continue_number_linchuang][1] = "bingcheng_jilu";
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showMubanBingli/muban_id/"+current_muban_id+"/muban_bingli_type/病程记录/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang ++;
		...
		temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
			temp_sub_menu_linchuang[continue_number_linchuang][0] = "بالنىتسىدىن چىققان خاتىرىلەش(出院记录)";
			temp_sub_menu_linchuang[continue_number_linchuang][1] = "chuyuan_jilu";
			temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showMubanBingli/muban_id/"+current_muban_id+"/muban_bingli_type/出院记录/yiyuan_id/"+current_bingli_yiyuan_id;
			temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
		continue_number_linchuang++;
		*/
		...
		$.getJSON("http://"+server_url+"/web_emr/Home/BingliEditor/getMubanTree", {muban_id:current_muban_id}, function(data){
			for(var bingli_count=0;bingli_count<data.length;bingli_count++)
			{
				temp_sub_menu_linchuang[continue_number_linchuang] = new Array();
				temp_sub_menu_linchuang[continue_number_linchuang][0] = data[bingli_count].bingli_type;
				temp_sub_menu_linchuang[continue_number_linchuang][1] = "ruyuan_jilu_muban";
				temp_sub_menu_linchuang[continue_number_linchuang][2] = "/web_emr/Home/BingliEditor/showMubanBingli/muban_id/"+current_muban_id+"/muban_bingli_type/"+data[bingli_count].bingli_type;
				temp_sub_menu_linchuang[continue_number_linchuang][3] = new Array();
				continue_number_linchuang++;
			}
		});
...
function refreshSubMultiMenu(temp_sub_menu_bingli,temp_sub_menu_linchuang,temp_sub_menu_huli)
{
	...
	/*$("#bingli_tree").append(
		'<li class="noSubMenu" id="last_li" state="closed"><b></b><input type="button" class="bingli_add_button" id="add_bingli"/></li>'
	);*/
	addTreeViewEvent();
}
