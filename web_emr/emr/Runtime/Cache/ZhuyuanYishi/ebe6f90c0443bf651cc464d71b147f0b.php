...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="content_table">
		<?php if(is_array($search_result)): $i = 0; $__LIST__ = $search_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$search_result): $mod = ($i % 2 );++$i; if($search_result['zhuangtai']!='住院中' and $search_result['zhuangtai']!='住院中   '): ?><tr class="list_content zhuangtai_yichuyuan"  zhuyuan_id="<?php echo ($search_result["zhuyuan_id"]); ?>" href="/web_emr/ZhuyuanYishi/Patient/showPatientZhuyuanDetail/zhuyuan_id/<?php echo ($search_result["zhuyuan_id"]); ?>/yiyuan_id/<?php echo ($search_result["yiyuan_id"]); ?>/xingming/<?php echo ($search_result["xingming"]); ?>/zhuangtai/<?php echo ($search_result["zhuangtai"]); ?>/special_info/<?php echo ($search_result["special_info"]); ?>">
						<td style="width:20%"><?php echo ($search_result["zhuyuan_id"]); ?></td>
						<td style="width:10%"><?php echo ($search_result["zhuyuan_chuanghao"]); ?></td>
						<td style="width:20%"><?php echo ($search_result["xingming"]); ?></td>
						<td style="width:7%"><?php echo ($search_result["nianling"]); ?></td>
						<td style="width:7%"><?php echo ($search_result["xingbie"]); ?></td>
						<td style="width:10%"><?php echo ($search_result["ruyuan_zhenduan"]); ?></td>
						<td style="width:15%"><?php echo ($search_result["yiyuan_name"]); ?></td>
				</tr>
			<?php else: ?>
