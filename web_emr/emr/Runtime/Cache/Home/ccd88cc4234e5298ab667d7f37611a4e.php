...
<body>
	<div class="page">
		<table class="show_info">
			<tr>
				<td width="120px" class="icon"><img class="icon" src="/web_emr/Public/css/images/operation_right.gif" /></td>
				<td class="content"><?php echo ($system_info); ?></td>
			</tr>
		</table>
		  <a id="href" href="/web_emr/System/showSystemChecked"></a>
    <br />
    等待时间： <b id="wait">3</b>
	</div>
</body>
