            ...
            <table border="1" width="100%" class="table_a">
              ...
              <tr>
                ...
                <td><select name="goods_category_id" id="goods_category_id">
                  ...
                  <?php if(is_array($category)): foreach($category as $key=>$vo): if($vo['cat_id'] == $data['goods_category_id']): ?><option value="<?php echo ($vo["cat_id"]); ?>" selected="selected"><?php echo ($vo["cat_name"]); ?></option>
                    <?php else: ?>
