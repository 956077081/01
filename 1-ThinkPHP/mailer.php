...
try {
    ...
    $mail->Username = '18706727398';                 // SMTP username
    $mail->Password = '13571733536';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 25;    //163邮箱 端口见   http://help.163.com/09/1223/14/5R7P3QI100753VB8.html                           // TCP port to connect to
    //Recipients 收件人
    $mail->setFrom('18706727398@163.com', 'fromsecretperson');  //发件人
    $mail->addAddress('app97924@126.com', '王子泉');     // Add a recipient
   // $mail->addAddress('ellen@example.com'); //多人时可再添加               // Name is optional
    $mail->addReplyTo('18706727398@163.com', '发送成功!');
